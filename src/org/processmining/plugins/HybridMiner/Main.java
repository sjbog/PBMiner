...
//				log = XLogReader.openLog ( "data/s2_wo_prefix_events_py.xes" );
			...
			outputPath = "./info/financialLog/filtered_logs/";
//			log = XLogReader.openLog ( outputPath + "O_.xes.gz" );
			log = XLogReader.openLog( outputPath + "financial_log_successful_path_only.xes.gz" );

//			XLogReader.findSameTimestampEvents( log );

			log = XLogReader.filterByEvents( log, "A_" );
//			log = XLogReader.fixOLogTimingOrder( log );
			XLogWriter.saveXesGz( log, outputPath + "A_" );

//			log = XLogReader.logWithoutRepeatEvents( log, "O_", "O_X" );
//			XLogWriter.saveXesGz( log, outputPath + "O_wo_repeat_events" );
